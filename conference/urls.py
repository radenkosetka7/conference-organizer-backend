...
from conference.views import EventTypeAPIView, ResourceItemAPIView, LocationListAPIView, \
    ...
    ConferenceListModeratorAPIView, ConferenceListOraganizerAPIView
...
urlpatterns = [
    ...
    path('user_events/', UserEventsListView.as_view(), name='user_events_list'), #ovdje sam stigao, id, i celery
